function IconSearchInSeconds() {
  return (
    <div className="bg-neutral-0 flex size-15 items-center justify-center rounded-xl border border-neutral-200 shadow-[0_1px_0_0_#e9ede8]">
      <svg
...
export default IconSearchInSeconds;
